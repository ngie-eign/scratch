...
class Service(object):
    ...
    def setup(self, argv=None, usage=None):
        ...
        parser.add_argument(
            "--conf", "-C", dest="config_file", help="configuration file"
        )
...
class Daemon(Service):
    ...
    def parse_args_pre(self, parser):
        ...
        """
        default_pidfile_path = os.path.join(
            VAR_RUN_PATH, "%s.pid" % (self.service_name,)
        )
        ...
        parser.add_argument("--runas-group", help="Group to run as", default="zuser")
        parser.add_argument("--runas-user", help="User to run as", default="zuser")
    ...
    def main(self, argv=None, usage=None):
        ...
        try:
            with daemon.DaemonContext(
                pidfile=pidlock_obj, gid=self.runas_group, uid=self.runas_user
            ):
